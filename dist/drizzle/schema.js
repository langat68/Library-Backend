...
exports.tableBooks = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
//state table
exports.tableBooks = (0, pg_core_1.pgTable)("Books", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    author: (0, pg_core_1.text)("author"),
    title: (0, pg_core_1.text)("title"),
    publicationyear: (0, pg_core_1.integer)("publication year")
});
// export type tiState=typeof tableState.$inferInsert;
// export type tsState=typeof tableState.$inferSelect;
// export type tsbooks=typeof tablebooks.$inferSelect;
